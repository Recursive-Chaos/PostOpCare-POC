const ro = {
  ...
  viewSubmittedQuestionnaire: "Vezi ce ai trimis",
  ...
  checkinSessionError: "Sesiune expirata. Autentifica-te din nou.",
  checkinSubmitError: "Nu am putut trimite check-in-ul.",
